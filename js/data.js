...
const crew = {
  ...
  mrsChippy:{ name:'Mrs. Chippy & the dogs', role:'The animals', note:'The carpenter’s cat and sixty-nine sledge dogs. What the ice made the Boss do about them was the price of every mouth he saved — and some of the men never quite forgave him for it.' },
};
...
n_routine:{ region:'beset', title:'The Empire of Small Hours',
  ...
  choices:[
    ...
    { t:'Ease off. They’re grown men, not schoolboys; let the dark find its own shape.',
      unity:-2, strength:-1, month:3, go:'n_pressure' },
...
n_dogs:{ region:'floecamp', title:'The Arithmetic With Fur On It',
  ...
  choices:[
    { t:'Order it done now, cleanly. And do the first team yourself, so no man carries what the Boss wouldn’t.',
      pre:'the price is paid at the top', hope:-2, stores:2, unity:1, go:'n_leopard' },
    { t:'Keep the teams through the winter drift — the men need the dogs more than the calories yet.',
      hope:1, stores:-2, go:'n_leopard' },
    { t:'Delegate it to the drivers quietly, team by team, no announcement.',
      hope:-1, stores:2, unity:-1, go:'n_leopard' },
  ]},
n_leopard:{ region:'floecamp', title:'Something Comes Up Through the Floor',
  text:`Orde-Lees is skiing back from a hunt when the floe erupts behind him.\n\nA sea leopard — twelve feet of muscle and hinge-jawed malice — has been tracking his shadow from under the ice, and now it is OUT, humping across the floe after him with terrible speed, all teeth and intent. He is screaming a word that has never been screamed on this floe before. The nearest rifle is leaning against the galley crates. The nearest man to the rifle is you.\n\nThe animal is also, a colder part of you notes, several hundred pounds of meat and blubber.`,
  choices:[
    { t:'Take the shot yourself — running target, one round, no time to think about missing.',
      pre:'the Boss shoots', strength:-1, stores:2, hope:1, go:'n_march' },
    { t:'Roar for Wild — the best rifle in the camp — and get Orde-Lees turning, zigzagging, ALIVE until it cracks.',
      pre:'the system saves him', unity:1, stores:2, go:'n_march' },
    { t:'Men first, meat never mind — everyone onto the high ridge until the animal loses interest.',
      hope:-1, stores:-1, go:'n_march' },
  ]},
...
n_elephant:{ region:'elephant', title:'Stone',
  text:`Elephant Island comes up out of the murk like a fist — black cliffs, glacier snouts, a beach of frozen shingle no wider than a street. It is the first solid ground under the nation in four hundred and ninety-seven days.\n\nYou have Blackborow — nineteen, stowaway, feet dead to the ankles — lifted over the gunwale first, the first human being ever to sit on this beach, because a man who may lose his feet should get something history can’t take back. The others stagger ashore and behave like drunks: laughing, falling, filling their pockets with stones, pressing their faces to the ground.\n\nIt lasts a day. Then everyone reads the sentence the beach has written: no ship comes here. No one looks here. The nation has landed on a stone shelf outside the world.`,
  choices:[
    { t:'Say it before they finish thinking it: a boat party goes for South Georgia. Eight hundred miles. You’ll lead it.',
      pre:'hope must have a schedule', hope:2, go:'n_hut' },
    { t:'Rest the nation a week first — bodies and boats both need rebuilding before anyone sails anywhere.',
      strength:2, month:1, hope:-1, go:'n_hut' },
  ]},
n_hut:{ region:'elephant', title:'The Snuggery',
  text:`The island greets its new tenants with a week of wind that shreds the tents like wet paper and sandblasts men’s faces with frozen gravel. So the nation builds the only architecture it has left: two boats upturned on low stone walls, chinked with moss and wrung-out blankets — a home five feet tall at the ridgepole, black with blubber smoke inside, and warm the way twenty-two bodies make a space warm. The men, unkillably, name it <em>the Snuggery.</em>\n\nAnd in the smoky dark, the surgeons draw you aside about Blackborow. The stowaway’s frostbitten toes have gone the final color. Macklin and McIlroy have chloroform, a scalpel, and a plan involving the blubber stove and the steadiest hour of the day. What they need from you is the thing everyone always needs from you: the decision made out loud.`,
  choices:[
    { t:'Order the operation done, and stand in the smoke while it happens — the boy watches YOUR face, not the knife.',
      pre:'the barometer holds at fair', hope:1, strength:-1, unity:1, go:'n_decide' },
    { t:'Leave written authority with Wild and the surgeons — done at their judgment, when weather and light allow.',
      unity:1, go:'n_decide' },
    { t:'Delay it. He’s nineteen. Maybe the feet turn. Maybe the rescue is quick.',
      hope:-1, strength:-1, go:'n_decide' },
  ]},

/* ---------- CH 6-7: THE CAIRD ---------- */
n_decide:{ region:'elephant', title:'The Two Crews',
  text:S=>`${S.men<27?'Twenty-'+['one','two','three','four','five','six'][S.men-21]+' men now. You have stopped being able to say the number without hearing the other one.\n\n':''}Two lists, and every name on each is a bet with a man’s life for a stake.\n\nThe boat: Worsley, because the crossing is a navigation problem wearing a boat costume. Crean, because Crean. McNish — the man who defied you on the ice — because he built the boat and can rebuild it at sea. Vincent and McCarthy to pull. And you, because the men left behind will only sit quiet under one promise: <em>the Boss is coming back for us.</em>\n\nThe beach: twenty-two men, upturned boats for a roof, winter coming — and one man to hold them: Frank Wild, your second self. His orders are a single sentence you write carefully: keep them alive and keep them ready.`,
  choices:[
...
const endings = {
  ...
  e_most:{ kind:'survive', art:'rescueart', title:S=>`${S&&S.men<27?'The Ones You Could':'Worn Through'}`,
    text:(S)=>`The Yelcho comes around the point with you at the rail, and the beach erupts — and you count them as they come off the stones, out loud, the way you have counted them for two years.\n\n${S&&S.men<27?`You bring home ${S.men} of the twenty-seven. History will call it a miracle, and history will be right, and you will spend the rest of your life at night with the names the ice kept. The Antarctic writes hard bargains. You signed the best one it offered.`:`All of them — alive, just. But the nation comes off that beach worn to wire and split at the seams you let open along the way: some of these men will never sail with you, speak of you, or forgive you. Everyone lived. Not everything survived.`}` },
